...
class Sub4Unlock {
    ...
    async create(params) {
        ...
        if (!res.data || !res.data.includes('sub4unlock.io')) {
            throw new Error('فشل to generate Sub4Unlock link')
        }
...
🔹 مثال:
.sub4unlock https://whatsapp.com/channel/0029Vb7obv8Fy72937jJb32V | yt=https://youtube.com/@Mustafa | ig=https://whatsapp.com/channel/0029Vb7obv8Fy72937jJb32V
🔹 Supported Actions:
