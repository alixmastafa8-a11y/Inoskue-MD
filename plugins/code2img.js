...
const handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!text) {
    return m.reply(
      `يرجى إدخال code or reply to a message containing code.\nمثال:\n*${usedPrefix}${command} console.log("Hello, World!");*`
    );
  }
  try {
    console.log(`جارٍ المعالجة code with theme and language detection`);
    ...
    console.error("فشل to send message:", e);
    m.reply("حدث خطأ.");
  }
};
