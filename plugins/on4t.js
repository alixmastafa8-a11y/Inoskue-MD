...
مثال: .on4t https://www.tiktok.com/@example/video/123456
*Supported Platforms:*
- TikTok
...
No watermark | Fast & Free`;
  try {
    ...
    throw err.message || 'فشل to download the video.';
  }
};
handler.help = ['on4t'];
handler.tags = ['downloader'];
handler.command = ['on4t']; 
handler.limit = true;
...
async function fetchInitialPage(initialUrl) {
  ...
  if (!csrfToken) throw new Error('Security token غير موجود.');
