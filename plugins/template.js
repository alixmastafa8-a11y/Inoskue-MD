let handler = async (m, { conn, text, args, usedPrefix, command }) => {
    ...
    menu.doc = false
    menu.button = false
    m.reply(`نجح change template *Image*`)
break 
    case 'gif':
    menu.image = false
    menu.gif = true
    ...
    menu.doc = false
    menu.button = false
    m.reply(`نجح change template *Gif*`)
break 
    case 'teks':
    menu.image = false
    menu.gif = false
    ...
    menu.doc = false
    menu.button = false
    m.reply(`نجح change template *Text*`)
break 
    ...
    menu.teks = false
    menu.doc = true
    m.reply(`نجح change template *Document*`)
break 
    case 'button':
    menu.image = false
    menu.gif = false
    ...
    menu.doc = false
    menu.button = true
    m.reply(`نجح change template *Button*`)
break 
    ...
    menu.gcTeks = false
    menu.gcDoc = false
    m.reply(`نجح change template welcome *Welcome/Goodbye Image*`)
break 
    case 'grupgif':
    menu.gcImg = false
    menu.gcGif = true
    menu.gcTeks = false
    menu.gcDoc = false
    m.reply(`نجح change template Group *Welcome/Goodbye Gif*`)
break 
    case 'grupteks':
    menu.gcImg = false
    menu.gcGif = false
    menu.gcTeks = true
    menu.gcDoc = false
    m.reply(`نجح change template Group *Welcome/Goodbye Text*`)
break 
    ...
    menu.gcTeks = false
    menu.gcDoc = true
    m.reply(`نجح change template Group *Welcome/Goodbye Document*`)
break 
    default:
 const data = {
    title: "Open here!",
