...
async function CapcutDl(url) {
  try {
    ...
    if (!script) throw new Error("فشل to find template data")
...
📥 طريقة الاستخدام: ${data.statistic.usage}
...
`
    ...
    m.reply("❌ فشل to fetch CapCut template. Please make sure the link is valid.")
  }
}
handler.help = ['كابكات-تحميل']
handler.command = ['كابكات-تحميل']
